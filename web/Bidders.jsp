...
<div id="templatemo_wrapper">
 ...
 <h1 colspan="2"><div  align="Right"></div> </td>
                    </h1>
     <%!
            Connection con;
    ...
    session.setAttribute("id",id);
        ...
        Statement st = con.createStatement();
            rs = st.executeQuery("select Bid_Details.BidderId,Currentprice,Product.ProductId from Product,Bid_Details where  Bid_Details.ProductId=Product.ProductId and Product.ProductId='" + id + "'order by Currentprice");	
         //executes the query and stores the result in resultset 'rs'
            ...
            <div style="position: top; width: 311px; height: 55px; z-index: 4; left: 600px; top: 350px" id="layer4">
                <font> <u><b><font face="Poor Richard"
	size="5">Bidders for  the ProductId -<strong><%=session.getAttribute("id") %></strong> </font></b></u> </font>
            </div>
            ...
            <table width="650" border="1" bordercolor="black">
                <tr>
					...
					<b><font face="Verdana" size="2">BidderId</font></b></td>
					<td align="center">
					<b>
					<font face="Verdana" size="2">Currentprice</font></b></td>
                    <td align="center">
					<b>
					<font face="Verdana" size="2">ProductId</font></b></td>
            ...
            while(rs.next())
            {
            	id = rs.getString(1); //gets the output values from the executed query
            ...
            <tr>
				...
				<td  align="center">
				<font  face="Verdana" size="2"><%=BidderId%></font></td>
                <td  align="center">
				<font  face="Verdana" size="2"><%=price%></font></td>  
				
                        <a href="javascript:confirmApproval('prod.jsp?id=<%=id%>')">   <%-- On clicking on confirm link, it navigates to ConfirmApproval.jsp--%>  
						<font face="Trebuchet MS" size="2" color="#797979"></font></a></b>
                    </td>
                </tr>
            <%
            }
