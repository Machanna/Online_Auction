...
<form name="f1" method="post"  action="editproduct.jsp">  
  
    <div id="container">
    <div  style="float:right;width:10%;border:0;font-color:#163362">
<a href=log.html">Log Out</a></div><br>

        <div class="content"><center>Edit Product Details</center><br>
            ...
            <div class="buttons">
                <center><button type="submit" class="primaryAction">Edit</button>
